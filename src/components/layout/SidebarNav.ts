...
export const ACHATS_ITEMS: NavItemV2[] = [
  ...
  { label: "Factures email", href: "/achats/email", icon: "fileText", roles: ["group_admin"] },
...
// Sections
export const PILOTAGE_SECTION: NavSubSection = { label: "Pilotage", icon: "barChart", permission: "performances.view", items: PILOTAGE_ITEMS };
