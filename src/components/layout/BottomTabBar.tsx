...
const SECTIONS_BELLO: TabSection[] = [SECTION_PILOTAGE, SECTION_PRODUCTION, SECTION_ACHATS, SECTION_HACCP, SECTION_MY_PLANNING];
const SECTIONS_PICCOLA: TabSection[] = [SECTION_PILOTAGE, SECTION_PRODUCTION_PICCOLA, SECTION_ACHATS_PICCOLA, SECTION_HACCP, SECTION_EVENTS, SECTION_MY_PLANNING];
