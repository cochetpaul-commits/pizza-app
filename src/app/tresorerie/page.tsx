...
const CAT_LABELS: Record<string, string> = {
  ...
  salaire: "Salaires",
  remuneration_gerant: "Remuneration gerant",
  ...
  pret: "Prets bancaires",
  leasing: "Leasing",
  blanchisserie: "Blanchisserie",
  entretien: "Entretien & maintenance",
  location: "Location",
  travaux: "Travaux & architecte",
...
const CAT_COLORS: Record<string, string> = {
  ...
  fournisseur: "#D4775A",
  salaire: "#5e7a8a",
  remuneration_gerant: "#4a6741",
  prestataire: "#7C3AED",
  charges_sociales: "#DC2626",
  impots: "#991B1B",
  assurance: "#0891B2",
  loyer: "#92400e",
  transfert_interne: "#6B7280",
  pret: "#374151",
  leasing: "#92400e",
  blanchisserie: "#0891B2",
  entretien: "#D97706",
  location: "#6B7280",
  travaux: "#B45309",
  comptabilite: "#059669",
  ...
  epargne_salariale: "#16A34A",
  frais_bancaires: "#9CA3AF",
