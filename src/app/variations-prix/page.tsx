...
function AlertCard({
  ...
  const accentColor = snoozed ? "#D1D5DB" : a.aberrant ? "#EA580C" : isUp ? "#DC2626" : "#16A34A";
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                border: `1.5px solid ${tab === t.key ? "#8B1A1A" : "rgba(217,199,182,0.95)"}`,
                background: tab === t.key ? "#8B1A1A" : "rgba(255,255,255,0.55)",
