...
export default function ArmorInvoicePage() {
  ...
  async function handlePreview() {
    ...
    try {
      ...
      const res = await fetchApi("/api/invoices/armor", {
        method: "POST",
  ...
  return (
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem" }}>
      ...
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: "1.5rem" }}>
        Import factures ARMOR EMBALLAGES
      </h1>
      ...
      <div style={{ margin: "1rem 0", padding: "1rem", background: "#f9f9f9", borderRadius: 8, border: "1px solid #ddd6c8" }}>
        ...
        {file ? (
          ...
          <p style={{ color: "#666" }}>Cliquez pour sélectionner un PDF de facture ARMOR EMBALLAGES</p>
        )}
      </div>
              ...
              {parsed.lines.map((l, i) => (
                <tr
                  ...
                  style={{
                    ...
                    background: l.unit_price == null ? "#fafafa" : undefined,
                    color: l.unit_price == null ? "#999" : undefined,
                  }}
                >
