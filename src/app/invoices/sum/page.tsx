...
export default function SumInvoicePage() {
  ...
  async function handlePreview() {
    ...
    try {
      ...
      const res = await fetchApi("/api/invoices/sum", {
        method: "POST",
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem" }}>
      ...
      <div style={{ margin: "1rem 0", padding: "1rem", background: "#f9f9f9", borderRadius: 8, border: "1px solid #ddd6c8" }}>
        ...
        {file ? (
          ...
          <p style={{ color: "#666" }}>Cliquez pour sélectionner un PDF de facture SUM</p>
        )}
      </div>
      ...
      {preview && parsed && !commitResult && (
        <div style={{ marginTop: "1.5rem" }}>
          ...
          <div style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 8, padding: "1rem", marginBottom: "1rem" }}>
            ...
            <p><strong>Lignes livrées :</strong> {parsed.lines.filter(l => l.notes !== "RUPTURE").length}</p>
            <p><strong>Ruptures :</strong> {parsed.lines.filter(l => l.notes === "RUPTURE").length}</p>
          </div>
              ...
              {parsed.lines.map((l, i) => (
                <tr
                  ...
                  style={{
                    ...
                    background: l.notes === "RUPTURE" ? "#fef9c3" : undefined,
                    color: l.notes === "RUPTURE" ? "#92400e" : undefined,
                  }}
                >
