...
export default function MaelInvoicePage() {
  ...
  async function getAuthHeader(): Promise<string> {
    // Récupère le token Supabase depuis le localStorage (standard Supabase JS)
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "2rem", fontFamily: "sans-serif" }}>
      <div style={{ display: "flex", gap: "0.75rem", marginBottom: "1.5rem" }}>
        ...
        >
          ↩ Accueil</button><button onClick={() => router.push("/invoices")} style={{ background: "transparent", border: "1px solid #ccc", borderRadius: 6, padding: "0.4rem 1rem", fontSize: "0.875rem", cursor: "pointer" }}>← Factures
        </button>
        <button
      ...
      >
        ...
        {file ? (
          ...
          <p style={{ color: "#666" }}>Cliquez pour sélectionner un PDF de facture METRO</p>
        )}
      </div>
