    ...
    <div style={{ minHeight: "100dvh", background: T.creme, animation: "slideUp 0.25s ease" }}>
      ...
      <div style={{ padding: "20px 16px 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
          <Tile href="/plannings" icon="&#x1F4CB;" title="Pointer"  sub="Presences du jour"       />
          <Tile href="/plannings" icon="&#x1F4C5;" title="Shifts"   sub="Creneaux de la semaine"   />
        </div>
        ...
        {isGroupAdmin && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
              <Tile href="/rh/equipe" icon="&#x1F465;" title="Equipe" sub="Membres, roles, contrats" wide />
            </div>
          </>
        )}
      </div>
