...
export default function SimulationPage() {
  ...
  const accentColor = etab?.couleur ?? "#e27f57";
    ...
    <RequireRole allowedRoles={["group_admin"]}>
      <div style={pageStyle}>
        <div style={{ marginBottom: 16 }}>
          <h1 style={titleStyle}>Simulation</h1>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 16 }}>
          {([
            ...
            <button key={t.key} type="button" onClick={() => setTab(t.key)} style={pillBtn(tab === t.key, accentColor)}>
              {t.label}
            </button>
          ))}
        </div>
          ...
          <>
            <div style={card}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
                ...
                <button type="button" onClick={addSimRow} style={addBtnStyle(accentColor)}>+ Ajouter un collaborateur</button>
              </div>
              ...
              <div style={card}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 20, fontWeight: 700, fontFamily: "var(--font-oswald), 'Oswald', sans-serif", color: accentColor }}>
                      {fmt(msProjetee)} EUR
                    </div>
                  </div>
                </div>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <div style={barBg}>
                    <div style={{ ...barFill, width: `${Math.min((ratioProjecte / 50) * 100, 100)}%`, background: accentColor }} />
                  </div>
                </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
                  <div style={{
                    ...
                    background: `${accentColor}0A`, border: `1px solid ${accentColor}33`,
                  }}>
...
const pillBtn = (active: boolean, color: string): React.CSSProperties => ({
  ...
  border: active ? `1px solid ${color}` : "1px solid #ddd6c8",
