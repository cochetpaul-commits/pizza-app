  ...
  return (
    <div style={{ minHeight: "100dvh", background: T.creme, animation: "slideUp 0.25s ease" }}>
      ...
      <div style={{ padding: "20px 16px 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 20 }}>
          <Tile href="/commandes"    icon="&#x1F6D2;" title="Commander"    sub="Mael · Metro · Masse"  accent={T.terracotta} wide />
          <Tile href="/mercuriale"   icon="&#x1F4B6;" title="Mercuriale"   sub="Prix du marche"        accent={T.terracotta} />
          <Tile href="/fournisseurs" icon="&#x1F69A;" title="Fournisseurs" sub="Contacts & tarifs"     accent={T.terracotta} />
        </div>
      </div>
    </div>
  );
