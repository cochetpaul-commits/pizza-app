...
const CAT_ORDER = ["cremerie_fromage","charcuterie_viande","maree","vins","spiritueux","biere","soft","cafeteria","liqueurs","sirops","legumes_herbes","fruit","epicerie_salee","epicerie_sucree","surgele","preparation","sauce","antipasti","emballage","autre"];
